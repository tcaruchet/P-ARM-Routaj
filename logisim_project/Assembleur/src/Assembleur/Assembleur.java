...
public class Assembleur { //4 bits pour etiquette, 4 bits pour mnemonique, 8 bits pour code imm
	...
	public static void main(String[] args) throws IOException{
		...
		BufferedReader in = new BufferedReader(new FileReader("D:\\enzod\\Polytech\\Archi\\td2\\SI3_ARCHI_PARM_Project\\SI3_ARCHI_PARM_Project/requete.txt"));
		String line;
		...
		BufferedReader in2 = new BufferedReader(new FileReader("D:\\enzod\\Polytech\\Archi\\td2\\SI3_ARCHI_PARM_Project\\SI3_ARCHI_PARM_Project/requete.txt"));
		String line2;
